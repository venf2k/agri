def create_placeholders(n_x, n_y):
    ...
    Arguments:
    n_x -- scalar, size of an image vector (num_px * num_px = 100 * 100 * 3 = 30.000)
...
def initialize_parameters(N = 30000, N1 = 25, N2 = 12, N3 = 8):
    ...
    W1 = tf.get_variable("W1", [N1,N], initializer = tf.contrib.layers.xavier_initializer(seed = 1))
...
def model(X_train, Y_train, X_test, Y_test, learning_rate = 0.0001,
          num_epochs = 1500, minibatch_size = 70, print_cost = True):
    """
